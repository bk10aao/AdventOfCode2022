...
public class DayOne {
    ...
    public int partTwo() {
        ...
        return totalPoints.get(totalPoints.size() - 1) + totalPoints.get(totalPoints.size() - 2) + totalPoints.get(totalPoints.size() - 3);
    }
    ...
    private static final String input = "15560\n" +
                                        "3906\n" +
                                        "7076\n" +
                                        "11980\n" +
                                        "11508\n" +
