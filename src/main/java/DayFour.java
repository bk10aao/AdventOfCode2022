...
public class DayFour {
    ...
    public int partOne(String input) {
        ...
        for (String s : input.split("\n")) {
            ...
            String[] fromValues = splitValues[0].split("-");
            String[] toValues = splitValues[1].split("-");

            int fromFirst = Integer.parseInt(fromValues[0]);
            int toFirst = Integer.parseInt(fromValues[1]);
    ...
    public int partTwo(String input) {
        ...
        for (String s : input.split("\n")) {
            ...
            int fromFirstLower = Integer.parseInt(fromValues[0]); //sec 1 lower
            int toFirstUpper = Integer.parseInt(fromValues[1]); //sec 1 upper
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Part one: %d\n", dayFour.partOne(input));
        dayFour = new DayFour();
        System.out.printf("Part two: %d\n", dayFour.partTwo(input));
    }

    private static final String input = "99-99,18-99\n" +
                                        "2-86,1-86\n" +
                                        "9-21,10-22\n" +
                                        "1-24,7-23\n" +
                                        "33-37,35-38\n" +
