...
public class DayThirteen {
    ...
    public static void main(String[] args) {
        DayThirteen dayThirteen = new DayThirteen(data);
        System.out.printf("Part one: %d\n", dayThirteen.partOne(input));
        dayThirteen = new DayThirteen(data);
        System.out.printf("Part two: %d", dayThirteen.partTwo(input));
    }
    ...
    int partOne(List<String> input) {
        ...
        for(int i = 0; i < input.size(); i += 3) {
            CompList list1 = CompList.parse(new Parser(input.get(i), 0));
            nodes.add(list1);
            CompList list2 = CompList.parse(new Parser(input.get(i + 1), 0));
            nodes.add(list2);
    ...
    int partTwo(List<String> input) {
        List<CompNode> nodes = new ArrayList<>();
        for(int i = 0; i < input.size(); i += 3) {
           nodes.add(CompList.parse(new Parser(input.get(i), 0)));
           nodes.add(CompList.parse(new Parser(input.get(i + 1), 0)));
        }
    ...
    private static final String data =  "[[[0,10]],[7,9,[[2,1],[7]],4,[[5,0,5,7,8],0,0,[10,3,3,2]]],[[1,[3,8,8,6,8],6,[1,3,7,9],[9,1,1,7]],[],[[1,0,4,10],8,5]],[]]\n" +
                                        "[[10,3,[[4],0,8]],[7,6,[]]]\n" +
                                        "\n" +
