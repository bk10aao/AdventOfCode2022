...
//    List<String> input;
//    public DayNine(String data) {
//        input = Arrays.asList(data.split("\n"));
//    }
//    public int partOne() {
...
//        s2Visited.add(snake1.get(snake1.size() - 1));
//
//        for (String s : input) {
//            String[] parts = s.split(" ");
//            int count = Integer.parseInt(parts[1]);
...
//                case "U" -> {
//                    for(int i = 0; i < count; i++) {
//                        Point head = snake1.get();
//                        head = new Point(head.x - 1, head.y);
//                        snake1.set(0, head);
//                        for(int j = 1; j < snake1.size(); j++) {
//
//                            head = snake1.get(j - 1);
//                            Point tail = snake1.get(j);
//
//                            head = new Point(head.x - 1, head.y);
//
//                            if(j == 0) {
...
//        DayNine dayNine = new DayNine(inputData);
//        System.out.printf("Part one: %d\n", dayNine.partOne());
//    }

    private static final String inputData =   "D 2\n" +
                                        "L 2\n" +
                                        "U 1\n" +
                                        "L 1\n" +
                                        "U 2\n" +
